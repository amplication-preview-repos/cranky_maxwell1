...
import { TradingPair } from "../../tradingPair/base/TradingPair";
...
export class OrderResolverBase {
  ...
  async createOrder(@graphql.Args() args: CreateOrderArgs): Promise<Order> {
    return await this.service.createOrder({
      ...
      data: {
        ...
        tradingPair: args.data.tradingPair
          ? {
              connect: args.data.tradingPair,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => TradingPair, {
    nullable: true,
    name: "tradingPair",
  })
  async getTradingPair(
    ...
    const result = await this.service.getTradingPair(parent.id);
